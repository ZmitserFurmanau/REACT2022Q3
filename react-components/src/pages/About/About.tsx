  ...
  return (
    <div className={styles.wrapper} data-testid="about">
      <p>
        ...
        The trust was created in 1936 to secure the financial and editorial independence of The
        Guardian in perpetuity and to safeguard the journalistic freedom and liberal values of The
        Guardian free from commercial or political interference. The trust was converted into a
